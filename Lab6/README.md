...
![Screenshot for tutorial 1](Tutorial_1_screenshot.jpg)


#### Task 2
screen capture for tutorial *Interactive Choropleth Map*:
![Screenshot for tutorial 2](Tutorial_2_screenshot.jpg)

#### Task 3
screen capture for custom map:
![Screenshot of custom outpTAMU map](custom_tamu_screenshot.jpg)